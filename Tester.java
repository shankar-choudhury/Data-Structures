...
public class Tester {
    ...
    private void initializeWordStats() {
        ...
        wA5 = new WordStat(new String[]{"Gdynia 10 Sopot", "", "Sopot 13 Gda?sk\nGda?sk 36 Gdynia 422 Bia?ystok",
        "Bia?ystok 198 Warsaw", "Lublin 173 Warsaw", "Warsaw 340 Gda?sk 290 Kraków 136 ?ód?", "?ód? 126 Cz?stochowa 217 Wroc?aw",
        "Cz?stochowa 73 Katowice 258 Wroc?aw 126 ?ód?", "Wroc?aw 182 Pozna?", "Pozna? 63 Gniezno 311 Warsaw", "Katowice"});
    ...
    public void tokenizerFileEdgeTester() {
        ...
        try {
            ...
            "gda?sk", "gda?sk", "36", "gdynia", "422", "bia?ystok", "bia?ystok", "198", "warsaw", "lublin", "173", "warsaw", "warsaw",
            "340", "gda?sk", "290", "kraków", "136", "?ód?", "?ód?", "126", "cz?stochowa", "217", "wroc?aw", "cz?stochowa", "73",
            "katowice", "258", "wroc?aw", "126", "?ód?", "wroc?aw", "182", "pozna?", "pozna?", "63", "gniezno", "311", "warsaw",
            "katowice"}));
        }
        catch (Throwable e) {
            e.printStackTrace();
    ...
    public void tokenizerArrayEdgeTester() {
        ...
        try {
            Tokenizer t5 = new Tokenizer(new String[]{"Gdynia 10 Sopot", "", "Sopot 13 Gda?sk\nGda?sk 36 Gdynia 422 Bia?ystok",
            "Bia?ystok 198 Warsaw", "Lublin 173 Warsaw", "Warsaw 340 Gda?sk 290 Kraków 136 ?ód?", "?ód? 126 Cz?stochowa 217 Wroc?aw",
            "Cz?stochowa 73 Katowice 258 Wroc?aw 126 ?ód?", "Wroc?aw 182 Pozna?", "Pozna? 63 Gniezno 311 Warsaw", "Katowice"});
            testArrayPermutation(t5.wordList(), List.of(new String[]{"gdynia", "10", "sopot", "sopot", "13",
            "gda?sk", "gda?sk", "36", "gdynia", "422", "bia?ystok", "bia?ystok", "198", "warsaw", "lublin", "173", "warsaw", "warsaw",
    ...
    public void wordStatArrayTester() {
        ...
        new WordStat(new String[]{"Gdynia 10 Sopot", "", "Sopot 13 Gda?sk\nGda?sk 36 Gdynia 422 Bia?ystok",
        "Bia?ystok 198 Warsaw", "Lublin 173 Warsaw", "Warsaw 340 Gda?sk 290 Kraków 136 ?ód?", "?ód? 126 Cz?stochowa 217 Wroc?aw",
        "Cz?stochowa 73 Katowice 258 Wroc?aw 126 ?ód?", "Wroc?aw 182 Pozna?", "Pozna? 63 Gniezno 311 Warsaw", "Katowice"});
    ...
    public void wordRankEdgeTester() {
        ...
        try {
            Assert.assertEquals(5, wF5.wordRank("bia?ystok"));
        }
        catch (Throwable e) {
            e.printStackTrace();
            failCount++;
        ...
        try {
            Assert.assertEquals(5, wA5.wordRank("bia?ystok"));
        }
        catch (Throwable e) {
            e.printStackTrace();
            failCount++;
    ...
    public void mostCommonWordsEdgeTester() {
        ...
        try {
            ...
            List.of(new String[]{"gda?sk", "?ód?", "wroc?aw"}));
            Assert.assertTrue(List.of(new String[]{"126", "gdynia", "sopot", "bia?ystok", "cz?stochowa", "katowice",
            "pozna?"}).contains(polandF[4]));
    ...
    public void mostCommonCollocationsEdgeTester() {
        ...
        try {
            ...
            List.of(new String[]{"gdynia", "sopot", "gda?sk", "bia?ystok"}));
        }
        catch (Throwable e) {
            e.printStackTrace();
            failCount++;
        ...
        try {
            ...
            int fContains = 0;
            for (String s : new String[]{"gda?sk", "?ód?", "wroc?aw"}) {
